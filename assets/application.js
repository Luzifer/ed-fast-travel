...
(function() {
  var bindUI, compileCoordinates, firstConnect, getProgressBar, getSystemLine, handleHashChange, handleRouteResult, handleShutdown, handleSystemAdd, handleSystemInputEvent, handleUpdate, loadSettings, route, saveSettings, searchSystemByName, searchTimer, setInputState, setWarning, sock, spawnSocket, systemCache;
  ...
  handleRouteResult = function(evt) {
    var data, editRow, el, i, j, len, len1, pbar, ref, ref1;
  ...
  getSystemLine = function() {
    return $('<tr class="auto-added"> <td class="right stop_no"></td> <td title="Click to copy system name" class="copy-system"> <span class="copy-text system_name"></span> <span class="coordinates"></span> </td> <td class="right flight_distance"></td> <td class="right total_flight_distance"></td> </tr>');
  };
