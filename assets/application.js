...
(function() {
  ...
  handleUpdateDatabase = function() {
    return $.get('/api/control/update-database', function(data) {
      return setWarning(data.error_message);
    });
  };
